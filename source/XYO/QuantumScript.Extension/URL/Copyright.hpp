...
namespace XYO::QuantumScript::Extension::URL::Copyright {
	XYO_QUANTUMSCRIPT_EXTENSION_URL_EXPORT std::string copyright();
	XYO_QUANTUMSCRIPT_EXTENSION_URL_EXPORT std::string publisher();
	XYO_QUANTUMSCRIPT_EXTENSION_URL_EXPORT std::string company();
	XYO_QUANTUMSCRIPT_EXTENSION_URL_EXPORT std::string contact();
};
